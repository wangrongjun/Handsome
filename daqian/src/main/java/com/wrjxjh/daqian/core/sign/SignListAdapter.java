...
public class SignListAdapter extends RecyclerView.Adapter {
    ...
    public SignListAdapter(Context context, List<SignListResult> signListResultList) {
        this.context = context;
        this.signListResultList = signListResultList;
    }

    public void updateThumbUpCount(int signId, int thumbUpCount) {
        for (SignListResult result : signListResultList) {
            if (result.getSign().getSignId() == signId) {
                result.setThumbUpCount(thumbUpCount);
            }
        }
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        holder.tvSignTime.setText(sign.getSignTime());
